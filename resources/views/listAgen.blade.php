...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const grid = document.getElementById('agen-grid');
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-footer" style="padding-top: 1rem; border-top: none; display: flex; flex-direction: column; gap: 1rem;">
                            <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; font-size: 0.85rem; color: var(--text-muted);">
                                ...
                                ${agen.id === 1 ? '' : `<span><i class="ph-fill ph-phone"></i> ${agen.contact}</span>`}
                            </div>
                            ${agen.id === 1 ? '' : `<a href="https://wa.me/${waNumber}" target="_blank" class="btn btn-primary" style="width: 100%; background: #25D366; box-shadow: 0 4px 14px 0 rgba(37, 211, 102, 0.39);">

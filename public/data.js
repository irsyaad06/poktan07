...
const hasilPanenList = [
    { petaniId: 1, name: "Beras Cianjur (Pandan Wangi)", qty: "2.5 Ton", price: "Rp 14.500/kg", image: "https://images.unsplash.com/photo-1586201375761-83865001e31c?auto=format&fit=crop&w=500&q=60", type: "Organik", grade: "Grade A" },
    { petaniId: 1, name: "Beras Merah Premium", qty: "800 Kg", price: "Rp 18.000/kg", image: "https://images.unsplash.com/photo-1600188769045-8bc261a87e0f?auto=format&fit=crop&w=500&q=60", type: "Organik", grade: "Grade A" },
    
    { petaniId: 2, name: "Bayam Hijau Hidroponik", qty: "150 Kg", price: "Rp 8.000/ikat", image: "https://images.unsplash.com/photo-1576045057995-568f588f82fb?auto=format&fit=crop&w=500&q=60", type: "Hidroponik", grade: "Premium" },
    { petaniId: 2, name: "Selada Air (Lettuce)", qty: "100 Kg", price: "Rp 12.000/kg", image: "https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?auto=format&fit=crop&w=500&q=60", type: "Hidroponik", grade: "Premium" },
    { petaniId: 2, name: "Wortel Manis Berastagi", qty: "300 Kg", price: "Rp 10.000/kg", image: "https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?auto=format&fit=crop&w=500&q=60", type: "Non-Pestisida", grade: "Grade A" },
    
    { petaniId: 3, name: "Mangga Harum Manis", qty: "500 Kg", price: "Rp 25.000/kg", image: "https://images.unsplash.com/photo-1553279768-865429fa0078?auto=format&fit=crop&w=500&q=60", type: "Organik", grade: "Ekspor" },
    { petaniId: 3, name: "Jeruk Medan Manis", qty: "400 Kg", price: "Rp 18.000/kg", image: "https://images.unsplash.com/photo-1611080626919-7cf5a9dbab5b?auto=format&fit=crop&w=500&q=60", type: "Organik", grade: "Grade A" },
    
    { petaniId: 4, name: "Jagung Manis Super", qty: "1.2 Ton", price: "Rp 7.500/kg", image: "https://images.unsplash.com/photo-1551754655-cd27e38d2076?auto=format&fit=crop&w=500&q=60", type: "Konvensional", grade: "Premium" },
    { petaniId: 4, name: "Kacang Tanah Kupas", qty: "400 Kg", price: "Rp 22.000/kg", image: "https://images.unsplash.com/photo-1599307767316-776affad8bf5?auto=format&fit=crop&w=500&q=60", type: "Konvensional", grade: "Grade A" },
    { petaniId: 4, name: "Kedelai Lokal", qty: "600 Kg", price: "Rp 11.000/kg", image: "https://images.unsplash.com/photo-1596547609652-9cb5d8d736bb?auto=format&fit=crop&w=500&q=60", type: "Konvensional", grade: "Grade B" },

    { petaniId: 5, name: "Jahe Merah Super", qty: "200 Kg", price: "Rp 45.000/kg", image: "https://images.unsplash.com/photo-1615486171448-4cbafcc28b52?auto=format&fit=crop&w=500&q=60", type: "Organik", grade: "Premium" },
    { petaniId: 5, name: "Kunyit Segar", qty: "300 Kg", price: "Rp 15.000/kg", image: "https://images.unsplash.com/photo-1615486511484-92e172cb4fec?auto=format&fit=crop&w=500&q=60", type: "Organik", grade: "Grade A" },

    { petaniId: 6, name: "Cabai Merah Keriting", qty: "150 Kg", price: "Rp 40.000/kg", image: "https://images.unsplash.com/photo-1588252303782-cb80119de0db?auto=format&fit=crop&w=500&q=60", type: "Non-Pestisida", grade: "Premium" },
    { petaniId: 6, name: "Tomat Ceri Merah", qty: "100 Kg", price: "Rp 20.000/kg", image: "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=500&q=60", type: "Non-Pestisida", grade: "Grade A" }
];
